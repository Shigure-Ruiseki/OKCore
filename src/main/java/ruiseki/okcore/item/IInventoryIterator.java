 ...
 */
public interface IInventoryIterator extends ListIterator<IImmutableItemStack> {

    IInventoryIterator EMPTY = new IInventoryIterator.EmptyInventoryIterator();

    @Override
    default void set(IImmutableItemStack immutableItemStack) {
        throw new UnsupportedOperationException("Cannot insert items into an InventorySourceIterator");
    }

    @Override
    default void add(IImmutableItemStack immutableItemStack) {
        throw new UnsupportedOperationException("Cannot insert items into an InventorySourceIterator");
    }
     ...
     */
    @Nonnegative
    int insert(IImmutableItemStack stack, boolean forced);
    ...
    class EmptyInventoryIterator implements IInventoryIterator {
        ...
        @Override
        public int insert(IImmutableItemStack stack, boolean force) {
        ...
        @Override
        public IImmutableItemStack next() {
            return null;
        }
