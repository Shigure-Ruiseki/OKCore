package ruiseki.okcore.mixins.early.network;
...
public abstract class MixinSimpleNetworkWrapper {
    ...
    @Shadow(remap = false)
    protected abstract <REPLY extends IMessage, REQ extends IMessage> SimpleChannelHandlerWrapper<REQ, REPLY> getHandlerWrapper(
