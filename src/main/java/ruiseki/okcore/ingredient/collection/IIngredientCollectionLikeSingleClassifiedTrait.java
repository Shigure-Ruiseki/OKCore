...
public interface IIngredientCollectionLikeSingleClassifiedTrait<T, M, I, C, L extends IIngredientCollectionLike<T, M, I>>
    ...
    public default boolean appliesToClassifier(M matchCondition) {
        return getComponent().getMatcher()
            .hasCondition(matchCondition, getCategoryType().getMatchCondition());
    }
    ...
    public default C getClassifier(T instance) {
        return getCategoryType().getClassifier()
            .apply(instance);
    }
    ...
    public default L getOrCreateClassifiedCollection(C classifier) {
        return this.getClassifiedCollections()
            .computeIfAbsent(classifier, k -> createEmptyCollection());
    }
    ...
    public static class ClassifiedIterator<T, M, I, C, L extends IIngredientCollectionLike<T, M, I>>
        ...
        public ClassifiedIterator(IIngredientCollectionLikeSingleClassifiedTrait<T, M, I, C, L> classifiedCollection) {
            ...
            this.classifierIterator = this.classifiedCollection.getClassifiedCollections()
                .entrySet()
                .iterator();
        ...
        protected void prepareNextIterators() {
            if ((this.instanceIterator == null || !this.instanceIterator.hasNext())
                ...
                this.instanceIterator = this.classifiedCollection.getClassifiedCollections()
                    .get(lastClassifierEntry.getKey())
                    .iterator();
            }
        }
        ...
        public void remove() {
            ...
            if (this.classifiedCollection.getClassifiedCollections()
                .get(this.lastClassifierEntry.getKey())
                .isEmpty()) {
    ...
    public static class ClassifiedIteratorDelegated<T, M, C, I, L extends IIngredientCollectionLike<T, M, I>>
        ...
        public ClassifiedIteratorDelegated(
            IIngredientCollectionLikeSingleClassifiedTrait<T, M, I, C, L> classifiedCollection, L collection,
            T instance, M matchCondition) {
            if (Objects.equals(
                classifiedCollection.getCategoryType()
                    .getMatchCondition(),
                matchCondition)) {
                this.iterator = collection.iterator();
            } else {
                M subMatchCondition = classifiedCollection.getComponent()
                    .getMatcher()
                    .withoutCondition(
                        matchCondition,
                        classifiedCollection.getCategoryType()
        ...
        public void remove() {
            ...
            if (this.classifiedCollection.getClassifiedCollections()
                .get(classifier)
                .isEmpty()) {
                this.classifiedCollection.getClassifiedCollections()
                    .remove(classifier);
            }
        }
    }
