 ...
 */
public class IngredientMapSingleClassified<T, M, V, C> extends IngredientMapAdapter<T, M, V> implements
    IIngredientCollectionLikeSingleClassifiedTrait<T, M, Map.Entry<T, V>, C, IIngredientMapMutable<T, M, V>> {
    ...
    public IngredientMapSingleClassified(IngredientComponent<T, M> component,
        Supplier<IIngredientMapMutable<T, M, V>> mapCreator, IngredientComponentCategoryType<T, M, C> categoryType) {
        super(component);
    ...
    public Iterator<Map.Entry<T, V>> iterator(T instance, M matchCondition) {
        if (appliesToClassifier(matchCondition)) {
            ...
            IIngredientMapMutable<T, M, V> collection = this.getClassifiedCollections()
