...
public interface ISlotlessItemHandler {
     ...
     * @return The remaining ItemStack that was not inserted (if the entire stack is accepted).
     ...
     * @return ItemStack extracted from the slot, if nothing can be extracted
     **/
