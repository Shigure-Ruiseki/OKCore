...
public class Images {
     ...
     */
    public static final Image[] BUTTON_ARROW_RIGHT = new Image[] { new Image(BUTTONS, 20, 0, 10, 15),
        new Image(BUTTONS, 0, 0, 10, 15), new Image(BUTTONS, 10, 0, 10, 15), };
    /**
     * 0: default; 1: active; 2: disabled
     */
    public static final Image[] BUTTON_ARROW_LEFT = new Image[] { new Image(BUTTONS, 20, 15, 10, 15),
        new Image(BUTTONS, 0, 15, 10, 15), new Image(BUTTONS, 10, 15, 10, 15), };
    /**
     * 0: default; 1: active; 2: disabled
     */
    public static final Image[] BUTTON_ARROW_DOWN = new Image[] { new Image(BUTTONS, 0, 50, 15, 10),
        new Image(BUTTONS, 0, 30, 15, 10), new Image(BUTTONS, 0, 40, 15, 10), };
    /**
     * 0: default; 1: active; 2: disabled
     */
