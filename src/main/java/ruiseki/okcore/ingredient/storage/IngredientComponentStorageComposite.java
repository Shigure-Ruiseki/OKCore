...
public class IngredientComponentStorageComposite<T, M> implements IIngredientComponentStorage<T, M> {
    ...
    public IngredientComponentStorageComposite(IngredientComponent<T, M> ingredientComponent,
        Collection<IIngredientComponentStorage<T, M>> storages) {
    ...
    public Iterator<T> iterator(@NotNull T prototype, M matchCondition) {
        return Iterators
            .concat(Iterators.transform(this.storages.iterator(), i -> i.iterator(prototype, matchCondition)));
    }
