 ...
 * {@link ICapabilityProvider#getCapability(Capability, ForgeDirection)}. A source must be effectively stateless. That
 * is, it
...
public interface IItemSink {
     ...
     */
    @Nonnegative
    int store(IImmutableItemStack stack);
     ...
     */
    @Nullable
    default IInventoryIterator sinkIterator() {
        return null;
    }
     ...
     */
    @Nullable
    default IInventoryIterator simulatedSinkIterator() {
        return null;
    }
     ...
     */
    default OptionalInt getStoredItemsInSink(@Nullable IItemStackPredicate filter) {
