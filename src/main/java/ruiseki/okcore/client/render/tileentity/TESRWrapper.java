...
package ruiseki.okcore.client.render.tileentity;
    ...
    public final void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
        ...
        if (b instanceof BlockOK blockOK && te.requiresTESR()) {
            ...
            try {
                ...
                OKCore.okLog(Level.ERROR, "Hi, Looks like there was a crash while rendering something...");
                t.printStackTrace();
                OKCore.okLog(Level.ERROR, "MC will now crash ( probably )!");
