...
public abstract class RecipeHandlerBase extends TemplateRecipeHandler implements IRecipeHandlerBase {
    ...
    public void loadCraftingRecipes(ItemStack result) {
        FluidStack fluid = NEIHelpers.getFluidStack(result);
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        FluidStack fluid = NEIHelpers.getFluidStack(ingredient);
        if (fluid != null && fluid.getFluid() != null) {
    ...
    @Override
    public java.util.List<String> handleTooltip(GuiRecipe<?> guiRecipe, java.util.List<String> currenttip, int recipe) {
    ...
    @Override
    public java.util.List<String> handleItemTooltip(GuiRecipe<?> guiRecipe, ItemStack itemStack,
        java.util.List<String> currenttip, int recipe) {
    ...
    public java.util.List<String> provideTooltip(GuiRecipe<?> guiRecipe, java.util.List<String> currenttip,
    ...
    public java.util.List<String> provideItemTooltip(GuiRecipe<?> guiRecipe, ItemStack itemStack,
        java.util.List<String> currenttip, CachedBaseRecipe crecipe, Point relMouse) {
    ...
    public void drawItemChance(int recipeIndex) {
        ...
        java.util.List<PositionedStack> allStacks = new ArrayList<>();
        if (crecipe.getResult() != null) {
            allStacks.add(crecipe.getResult());
        }

        java.util.List<PositionedStack> ingredients = crecipe.getIngredients();
        if (ingredients != null) {
            allStacks.addAll(ingredients);
        }

        java.util.List<PositionedStack> others = crecipe.getOtherStacks();
        if (others != null) {
    ...
    public void drawFluidChance(int recipeIndex) {
        ...
        java.util.List<PositionedFluidTank> tanks = crecipe.getFluidTanks();
    ...
    public abstract class CachedBaseRecipe extends CachedRecipe {
        ...
        public java.util.List<PositionedFluidTank> getFluidTanks() {
