...
public interface IIngredientCollectionLikeMultiClassifiedTrait<T, M, I, L extends IIngredientCollectionLike<T, M, I>>
    ...
    public default IngredientComponentCategoryType<T, M, ?> getFirstMatchingCategory(M matchCondition) {
        ...
        for (IngredientComponentCategoryType<T, M, ?> categoryType : getComponent().getCategoryTypes()) {
            if (getComponent().getMatcher()
                .hasCondition(matchCondition, categoryType.getMatchCondition())) {
                return categoryType;
            }
        }
    ...
    public static class RemoveCallbackIterator<T, M, I, L extends IIngredientCollectionLike<T, M, I>>
        ...
        public RemoveCallbackIterator(
            IIngredientCollectionLikeMultiClassifiedTrait<T, M, I, L> multiClassifiedCollection, T instance,
            M matchCondition) {
            ...
            this.otherClassifiedCollections = Lists.newArrayList(
                this.multiClassifiedCollection.getClassifiedCollections()
                    .values());
