...
public class EnergyHandlerComponent implements IEnergyHandler {

    @NotNull
    private final TileEntity tile;

    public EnergyHandlerComponent(@NotNull TileEntity tile) {
        this.tile = tile;
    }

    protected LazyOptional<IEnergyStorage> getCapability(ForgeDirection side) {
