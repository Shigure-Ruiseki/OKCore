...
public interface IIngredientComponentStorage<T, M> extends Iterable<T> {
     ...
     *         then return {@link ruiseki.commoncapabilities.api.ingredient.IIngredientMatcher#getEmptyInstance()}).
     ...
     *                       by according to {@link IngredientComponent#getMatcher()}.
     * @param simulate       If true, the insertion is only simulated
     * @return Ingredient extracted from the slot, must be
     *         {@link ruiseki.commoncapabilities.api.ingredient.IIngredientMatcher#getEmptyInstance()},
