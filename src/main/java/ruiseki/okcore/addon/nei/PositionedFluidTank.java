...
public class PositionedFluidTank {
    ...
    public float chance;
    private final java.util.List<String> tooltip = new ArrayList<>();
        ...
        if (chance <= 0.0F) {
            this.tooltip.add(
                EnumChatFormatting.GRAY
                    + String.format(NEIHelpers.translate("chance"), NEIHelpers.translate("chance.never")));
        } else if (chance < 0.01F) {
            this.tooltip.add(
                EnumChatFormatting.GRAY
                    + String.format(NEIHelpers.translate("chance"), NEIHelpers.translate("chance.lessThan1")));
        } else if (chance != 1.0F) {
            NumberFormat percentFormat = NumberFormat.getPercentInstance();
            percentFormat.setMaximumFractionDigits(2);
            this.tooltip.add(
                EnumChatFormatting.GRAY
                    + String.format(NEIHelpers.translate("chance"), String.valueOf(percentFormat.format(chance))));
        }
        return this;
    }
}
