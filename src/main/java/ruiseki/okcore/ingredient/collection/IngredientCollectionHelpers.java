...
public class IngredientCollectionHelpers {
     ...
     */
    public static <T, M> IIngredientCollapsedCollectionMutable<T, M> createCollapsedCollection(
        IngredientComponent<T, M> ingredientComponent) {
        if (ingredientComponent.getCategoryTypes()
            .size() == 1) {
        ...
        return new IngredientCollectionSingleClassifiedCollapsed<>(
            ...
            ingredientComponent.getCategoryTypes()
                .get(0));
    }
