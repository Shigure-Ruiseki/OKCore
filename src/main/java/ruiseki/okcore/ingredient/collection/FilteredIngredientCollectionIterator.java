...
public class FilteredIngredientCollectionIterator<T, M> implements Iterator<T> {
     ...
     */
    public FilteredIngredientCollectionIterator(Iterable<T> iterable, IIngredientMatcher<T, M> matcher, T instance,
        M matchCondition) {
     ...
     * @param matchCondition A match condition to filter by.
     */
    public FilteredIngredientCollectionIterator(Iterator<T> iterator, IIngredientMatcher<T, M> matcher, T instance,
        M matchCondition) {
