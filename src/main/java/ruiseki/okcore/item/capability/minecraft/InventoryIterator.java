...
public class InventoryIterator extends AbstractInventoryIterator {
    ...
    public InventoryIterator(IInventory inv, ForgeDirection side, int[] allowedSlots) {
    ...
    public InventoryIterator(IInventory inv, ForgeDirection side, int[] inventorySlots, int[] allowedSlots) {
    ...
    public ItemStack extract(int amount, boolean forced) {
        ...
        if (ItemStackHelpers.isStackEmpty(inSlot)) return null;
    ...
    public int insert(IImmutableItemStack stack, boolean forced) {
        ...
        if (!ItemStackHelpers.isStackEmpty(inSlot) && !stack.matches(inSlot)) {
        ...
        if (!ItemStackHelpers.isStackEmpty(inSlot)) {
