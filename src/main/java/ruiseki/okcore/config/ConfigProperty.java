...
public final class ConfigProperty {
     ...
     * @param field         The field of the {@link ruiseki.okcore.config.extendedconfig.ExtendedConfig} this property
     *                      refers to.
     */
    ...
    public void save(Configuration config, boolean forceUpdate) {
        ...
        if (value instanceof Integer) {
            ...
            mod.log(Level.ERROR, "Invalid config property class. No match found for '" + name + "': '" + value + "'");
        }
