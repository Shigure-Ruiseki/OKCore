 ...
 *
 */
public class ConfigurableItemTool extends ItemTool implements IConfigurableItem, IItemCapability, IItemSharedTag {
     ...
     */
    public ConfigurableItemTool(ExtendedConfig<ItemConfig> eConfig, float damageVsEntity,
        Item.ToolMaterial toolMaterial, Set<Block> blocks) {
        super(damageVsEntity, toolMaterial, blocks);
