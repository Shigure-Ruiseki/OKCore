 ...
 * as instances are compared using the matcher in
 * {@link ruiseki.commoncapabilities.api.ingredient.IngredientComponent#getMatcher()}.
 *
...
public interface IIngredientMap<T, M, V> extends IIngredientCollectionLike<T, M, Map.Entry<T, V>> {
    ...
    public default boolean containsKey(T instance, M matchCondition) {
        ...
        return this.iterator(instance, matchCondition)
            .hasNext();
    }
