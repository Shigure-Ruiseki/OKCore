...
public class IngredientCollectionQuantitativeGrouper<T, M, I extends IIngredientList<T, M> & IIngredientCollectionMutable<T, M>>
    ...
    public IngredientCollectionQuantitativeGrouper(I innerCollection, boolean ignoreInnerCollectionEmptyCheck) {
        ...
        this.quantifierlessMatchCondition = matcher
            .withoutCondition(matcher.getExactMatchCondition(), getPrimaryQuantifier().getMatchCondition());
    ...
    public void setQuantity(T instance, long quantity) {
        ...
        if (modifyQuantity > 0) {
            ...
            this.add(
                this.getComponent()
                    .getMatcher()
                    .withQuantity(instance, modifyQuantity));
