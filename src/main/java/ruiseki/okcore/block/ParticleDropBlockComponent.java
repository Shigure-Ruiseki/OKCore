...
import ruiseki.okcore.client.particle.ExtendedParticleDrop;
...
public class ParticleDropBlockComponent implements IEntityDropParticleFXBlock {
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        ...
        if (rand.nextInt(chance) == 0
            ...
            EntityFX fx = new ExtendedParticleDrop(world, px, py, pz, particleRed, particleGreen, particleBlue);
